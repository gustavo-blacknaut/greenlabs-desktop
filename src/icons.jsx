...
export const ShrinkIcon = ({ size = 18 }) => (
  <svg {...iconProps(size)}>
...
export const ServerIcon = ({ size = 18 }) => (
  <svg {...iconProps(size)}>
...
export const RadioIcon = ({ size = 18 }) => (
  <svg {...iconProps(size)}>
...
export const SingleIcon = ({ size = 18 }) => (
  <svg {...iconProps(size)}>
    <rect x="3" y="4" width="18" height="16" rx="2" />
  </svg>
);

export const SplitIcon = ({ size = 18 }) => (
  <svg {...iconProps(size)}>
    <rect x="3" y="4" width="18" height="16" rx="2" />
    <path d="M12 4v16" />
  </svg>
...
export const WinMaxIcon = ({ maximized = false }) => (
